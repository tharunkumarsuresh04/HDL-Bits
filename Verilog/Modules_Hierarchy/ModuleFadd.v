/*
In this exercise, you will create a circuit with two levels of hierarchy. Your top_module will instantiate two copies of add16 (provided), each of which will instantiate 16 copies of add1 (which you must write). 
...
module top_module (
    ...
    add16 add16_inst(.a(a[31:16]), .b(b[31:16]), .cin(w1), .sum(sum[31:16]));
